...
public class BoardController {
    ...
    */
    ...
    public String list(
            ...
            Model model                                     // 뷰에 전달할 데이터를 담는 Model
    ) {
        ...
        model.addAttribute("boards", boards);           // 전체 게시글 목록
        model.addAttribute("currentPage", page);        // 선택한 현재 페이지 번호(1-based)
        ...
        model.addAttribute("nextGroupPage", nextGroupPage); // 다음 그룹으로 이동 시 페이지 번호
