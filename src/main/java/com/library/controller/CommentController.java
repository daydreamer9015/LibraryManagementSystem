...
public class CommentController {
    ...
    public ResponseEntity<CommentDTO> createComment(
            ...
            @Valid @RequestBody CommentCreateDTO dto, // 요청 본문(JSON)을 DTO 변환 후 유효성 검증
    ...
    public ResponseEntity<CommentDTO> updateComment(
        ...
        log.info("댓글 수정 요청 - 게시글 ID: {}, 수정자: {}", commentId, userDetails.getUsername());
    ...
    /*
        댓글 삭제 API - DELETE /api/comments/{commentId}, 댓글 소프트 삭제
     */
    ...
    public ResponseEntity<Void> deleteComment(
        ...
        return ResponseEntity.noContent().build();      // HTTP 204 No Content 상태코드로 응답
    }
}
